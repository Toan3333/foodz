...
exports.Axios = Axios;
},{"./lib/axios.js":"node_modules/axios/lib/axios.js"}],"app/services/orderService.js":[function(require,module,exports) {
"use strict";
...
var orderService = /*#__PURE__*/_createClass(function orderService(endPoint) {
  var _this = this;
  _classCallCheck(this, orderService);
  _defineProperty(this, "getOrder", /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    var response;
  ...
  _defineProperty(this, "addOrder", /*#__PURE__*/function () {
    var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(createOrder) {
      var response;
      return _regeneratorRuntime().wrap(function _callee2$(_context2) {
        while (1) switch (_context2.prev = _context2.next) {
          case 0:
            _context2.next = 2;
            return _axios.default.post(_this.endPoint + _this.collectionName, createOrder);
          case 2:
  ...
  _defineProperty(this, "deleteOrder", /*#__PURE__*/function () {
...
},{}],"app/checkout.js":[function(require,module,exports) {
"use strict";
...
function asyncGeneratorStep(n, t, e, r, o, a, c) { try { var i = n[a](c), u = i.value; } catch (n) { return void e(n); } i.done ? t(u) : Promise.resolve(u).then(r, o); }
function _asyncToGenerator(n) { return function () { var t = this, e = arguments; return new Promise(function (r, o) { var a = n.apply(t, e); function _next(n) { asyncGeneratorStep(a, r, o, _next, _throw, "next", n); } function _throw(n) { asyncGeneratorStep(a, r, o, _next, _throw, "throw", n); } _next(void 0); }); }; }
var orderApi = new _orderService.default(_JsonServerConstants.default.EndPoint);
var currentDate = new Date();
var formattedDate = "".concat(currentDate.getDate().toString().padStart(2, "0"), "-").concat((currentDate.getMonth() + 1).toString().padStart(2, "0"), "-").concat(currentDate.getFullYear());
// Định dạng ngày thành chuỗi

var cart = localStorage.getItem("cart") ? JSON.parse(localStorage.getItem("cart")) : [];
console.log(cart);
var checkoutList = document.querySelector("#checkout-list");
var totalCheckout = document.querySelector("#totolCheckout");
console.log(checkoutList);
function renderCheckout() {
  cart.forEach(function (item) {
    var template = "<div class=\"checkout-detail__box-item\">\n    <div class=\"checkout-detail__box-image\">\n      <img src=\"".concat(item.image, "\" alt=\"\" />\n    </div>\n    <div class=\"checkout-detail__box-body\">\n      <div class=\"checkout-detail__box-name\">").concat(item.name, "</div>\n      <div class=\"checkout-detail__box-price\">$ ").concat(item.price, "</div>\n      <div class=\"checkout-detail__box-quantity\">\n        <span class=\"quantity-checkout\">Quantity: ").concat(item.qty, "</span>\n      </div>\n    </div>\n  </div>");
...
function total() {
  ...
  totalCheckout.innerHTML = "$ ".concat(sum);
}
var totalAmount = cart.reduce(function (total, item) {
  return total + item.price * item.qty;
}, 0);
var formOrder = document.querySelector(".form-order");
formOrder.addEventListener("submit", /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(e) {
    var name, phone, address, cart, createOrder;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          e.preventDefault();
          ...
          address = document.getElementById("address").value; // Lấy dữ liệu từ giỏ hàng
...
},{"./services/orderService":"app/services/orderService.js","./constants/JsonServerConstants":"app/constants/JsonServerConstants.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
},{}]},{},["node_modules/parcel-bundler/src/builtins/hmr-runtime.js","app/checkout.js"], null)
//# sourceMappingURL=/checkout.e0675d7a.js.map