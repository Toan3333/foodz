...
exports.Axios = Axios;
},{"./lib/axios.js":"node_modules/axios/lib/axios.js"}],"app/services/blogService.js":[function(require,module,exports) {
"use strict";
...
var blogService = /*#__PURE__*/_createClass(function blogService(endPoint) {
  var _this = this;
  _classCallCheck(this, blogService);
  _defineProperty(this, "getBlog", /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    var response;
  ...
  _defineProperty(this, "addBlog", /*#__PURE__*/function () {
    var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(newBlog) {
      var response;
      return _regeneratorRuntime().wrap(function _callee2$(_context2) {
        while (1) switch (_context2.prev = _context2.next) {
          case 0:
            _context2.next = 2;
            return _axios.default.post(_this.endPoint + _this.collectionName, newBlog);
          case 2:
  ...
  _defineProperty(this, "deleteBlog", /*#__PURE__*/function () {
  ...
  _defineProperty(this, "getBlogById", /*#__PURE__*/function () {
  ...
  _defineProperty(this, "editBlog", /*#__PURE__*/function () {
    var _ref5 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee5(id, newUpdateBlog) {
      var response;
      return _regeneratorRuntime().wrap(function _callee5$(_context5) {
        while (1) switch (_context5.prev = _context5.next) {
          case 0:
            _context5.prev = 0;
            _context5.next = 3;
            return _axios.default.put("".concat(_this.endPoint).concat(_this.collectionName, "/").concat(id), newUpdateBlog);
          case 3:
  ...
  _defineProperty(this, "getlastId", /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee6() {
    var response, blog;
    return _regeneratorRuntime().wrap(function _callee6$(_context6) {
      while (1) switch (_context6.prev = _context6.next) {
        ...
        case 7:
          return _context6.abrupt("return", (parseInt(blog[blog.length - 1].id, 10) + 1).toString());
        case 10:
          _context6.prev = 10;
...
var _default = exports.default = blogService;
...
},{}],"app/listBlogAdmin.js":[function(require,module,exports) {
"use strict";
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          _context.prev = 5;
          _context.next = 8;
          return blogApi.getlastId();
        case 8:
          lastId = _context.sent;
          _context.next = 11;
          return blogApi.addBlog({
            id: lastId,
            title: title,
            image: image,
            description: desc
...
showBlog.addEventListener("click", /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(e) {
    var id, productRow, _id;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
...
function handleEdit(_x3) {
  return _handleEdit.apply(this, arguments);
}
function _handleEdit() {
  _handleEdit = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4(id) {
    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
      while (1) switch (_context4.prev = _context4.next) {
        case 0:
          _context4.next = 2;
...
var formEditBlog = document.querySelector("#formEditBlog");
formEditBlog.addEventListener("submit", /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(e) {
    var titleUpdate, imageUpdate, descUpdate, id, updateBlog;
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        case 0:
          e.preventDefault();
          titleUpdate = document.getElementById("titleUpdate").value;
          imageUpdate = document.getElementById("imageUpdate").value;
          descUpdate = document.getElementById("descUpdate").value;
          id = document.getElementById("blogId").value;
          _context3.prev = 5;
          _context3.next = 8;
          return blogApi.editBlog(id, {
            title: titleUpdate,
            image: imageUpdate,
            description: descUpdate
          });
        case 8:
          updateBlog = _context3.sent;
          closeModalUpdate();
...
blogApi.getBlog().then(function (data) {
  console.log(data);
  data.forEach(function (item) {
    renderBlogAdmin(item);
  });
});
},{"./services/blogService":"app/services/blogService.js","./constants/JsonServerConstants":"app/constants/JsonServerConstants.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
},{}]},{},["node_modules/parcel-bundler/src/builtins/hmr-runtime.js","app/listBlogAdmin.js"], null)
//# sourceMappingURL=/listBlogAdmin.b2fe248a.js.map