...
})({"5W6M4":[function(require,module,exports) {
...
module.bundle.HMR_BUNDLE_ID = "16fd6e9579923fb5";
"use strict";
...
// Lấy địa chỉ api
const categoryApi = new (0, _categoryServiceDefault.default)((0, _jsonServerConstantsDefault.default).EndPoint);
// Khai báo biến
...
formEdit.addEventListener("submit", async (event)=>{
    ...
    try {
        const updatedCategory = await categoryApi.editCategory(categoryId, {
            name: nameUpdate
        });
        closeModalUpdate();
...
},{"./services/CategoryService":"1bIMI","./constants/JsonServerConstants":"6L6hL","@parcel/transformer-js/src/esmodule-helpers.js":"2GZEo"}],"1bIMI":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
class CategoryService {
    ...
    addCategories = async (newCategory)=>{
        const response = await (0, _axiosDefault.default).post(this.endPoint + this.collectionName, newCategory);
        return response.data;
    };
    getCategoryById = async (categoryId)=>{
        const response = await (0, _axiosDefault.default).get(this.endPoint + this.collectionName + "/" + categoryId);
        return response.data;
    };
    getlastId = async ()=>{
        try {
    ...
    editCategory = async (categoryId, newUpdateCategory)=>{
        try {
            const response = await (0, _axiosDefault.default).put(`${this.endPoint}${this.collectionName}/${categoryId}`, newUpdateCategory);
            return response.data;
        } catch (error) {
            console.log(error);
        }
...
},{"axios":"jo6P5","@parcel/transformer-js/src/esmodule-helpers.js":"2GZEo"}]},["5W6M4","aCsa9"], "aCsa9", "parcelRequire06c3")

//# sourceMappingURL=categories.79923fb5.js.map
