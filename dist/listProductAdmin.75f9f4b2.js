...
exports.Axios = Axios;
},{"./lib/axios.js":"node_modules/axios/lib/axios.js"}],"app/services/productService.js":[function(require,module,exports) {
"use strict";
...
var productService = /*#__PURE__*/_createClass(function productService(endPoint) {
  var _this = this;
  _classCallCheck(this, productService);
  _defineProperty(this, "findAllProducts", /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    var response;
  ...
  _defineProperty(this, "addAllProducts", /*#__PURE__*/function () {
    var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(newProduct) {
      ...
      return _regeneratorRuntime().wrap(function _callee2$(_context2) {
        while (1) switch (_context2.prev = _context2.next) {
          case 0:
            _context2.next = 2;
            return _axios.default.post(_this.endPoint + _this.collectionName, newProduct);
          case 2:
    ...
    var _ref3 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(id) {
      ...
      return _regeneratorRuntime().wrap(function _callee3$(_context3) {
        while (1) switch (_context3.prev = _context3.next) {
          case 0:
            _context3.next = 2;
            return _axios.default.get(_this.endPoint + _this.collectionName + "/" + id);
          case 2:
  ...
  _defineProperty(this, "getlastId", /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4() {
    ...
    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
      while (1) switch (_context4.prev = _context4.next) {
        ...
        case 7:
          return _context4.abrupt("return", (parseInt(products[products.length - 1].id, 10) + 1).toString());
        case 10:
          _context4.prev = 10;
          _context4.t0 = _context4["catch"](0);
          console.error("Error getting last product ID:", _context4.t0);
        case 13:
        case "end":
    ...
    var _ref5 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee5(productId) {
      ...
      return _regeneratorRuntime().wrap(function _callee5$(_context5) {
        while (1) switch (_context5.prev = _context5.next) {
          case 0:
            _context5.next = 2;
            return _axios.default.delete("".concat(_this.endPoint).concat(_this.collectionName, "/").concat(productId));
          case 2:
  ...
  _defineProperty(this, "updateProduct", /*#__PURE__*/function () {
    var _ref6 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee6(productId, updatedProduct) {
      var response;
      return _regeneratorRuntime().wrap(function _callee6$(_context6) {
        while (1) switch (_context6.prev = _context6.next) {
          case 0:
            _context6.next = 2;
            return _axios.default.put("".concat(_this.endPoint).concat(_this.collectionName, "/").concat(productId), updatedProduct);
          case 2:
...
},{}],"app/listProductAdmin.js":[function(require,module,exports) {
var define;
"use strict";
...
function asyncGeneratorStep(n, t, e, r, o, a, c) { try { var i = n[a](c), u = i.value; } catch (n) { return void e(n); } i.done ? t(u) : Promise.resolve(u).then(r, o); }
function _asyncToGenerator(n) { return function () { var t = this, e = arguments; return new Promise(function (r, o) { var a = n.apply(t, e); function _next(n) { asyncGeneratorStep(a, r, o, _next, _throw, "next", n); } function _throw(n) { asyncGeneratorStep(a, r, o, _next, _throw, "throw", n); } _next(void 0); }); }; }
var productsApi = new _productService.default(_JsonServerConstants.default.EndPoint);
...
function _addProduct() {
  _addProduct = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    var name, price, image, category, lastId, newProduct, addedProduct;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
        ...
        case 7:
          ...
          _context.next = 11;
          return productsApi.addAllProducts(newProduct);
        case 11:
...
function _handleDelete() {
  _handleDelete = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(event) {
    var productId, productRow;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
        ...
        case 5:
          productRow = event.target.closest("tr");
          productRow.remove();
          _context2.next = 12;
          break;
        case 9:
          ...
          console.error("Error deleting product:", _context2.t0);
        case 12:
        case "end":
          return _context2.stop();
      }
...
function _handleEdit() {
  _handleEdit = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(event) {
    var productId;
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        case 0:
        ...
        case 14:
          ...
          console.error("Error fetching product data for edit:", _context3.t0);
        case 17:
        case "end":
          return _context3.stop();
      }
...
function _handleUpdate() {
  _handleUpdate = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4() {
    var nameUpdate, priceUpdate, imageUpdate, categoryUpdate, productId, updatedProduct, updatedProducted;
    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
      while (1) switch (_context4.prev = _context4.next) {
        case 0:
          if (!currentProduct) {
          ...
          imageUpdate = document.getElementById("imageUpdate").value;
          categoryUpdate = document.getElementById("categoryUpdate").value; // Lấy giá trị productId từ trường ẩn
          productId = document.getElementById("productId").value; // Tạo đối tượng chứa dữ liệu sản phẩm
          updatedProduct = {
            name: nameUpdate,
            image: imageUpdate,
          ...
          _context4.prev = 7;
          _context4.next = 10;
          return productsApi.updateProduct(productId, updatedProduct);
        case 10:
          updatedProducted = _context4.sent;
...
productsApi.findAllProducts().then(function (data) {
  console.log(data);
  data.forEach(function (item) {
    renderProductAdmin(item);
  });
});
},{"./services/productService":"app/services/productService.js","./constants/JsonServerConstants":"app/constants/JsonServerConstants.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
},{}]},{},["node_modules/parcel-bundler/src/builtins/hmr-runtime.js","app/listProductAdmin.js"], null)
//# sourceMappingURL=/listProductAdmin.75f9f4b2.js.map