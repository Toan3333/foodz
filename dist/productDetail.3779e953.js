...
},{}],"app/productDetail.js":[function(require,module,exports) {
"use strict";
...
function asyncGeneratorStep(n, t, e, r, o, a, c) { try { var i = n[a](c), u = i.value; } catch (n) { return void e(n); } i.done ? t(u) : Promise.resolve(u).then(r, o); }
function _asyncToGenerator(n) { return function () { var t = this, e = arguments; return new Promise(function (r, o) { var a = n.apply(t, e); function _next(n) { asyncGeneratorStep(a, r, o, _next, _throw, "next", n); } function _throw(n) { asyncGeneratorStep(a, r, o, _next, _throw, "throw", n); } _next(void 0); }); }; }
var productDetailApi = new _productService.default(_JsonServerConstants.default.EndPoint);
var productMain = document.querySelector(".product-detail__main");
var foodList = document.querySelector(".food-list");

// render sản phẩm new
productDetailApi.findAllProducts().then(function (data) {
  var newProduct = data.filter(function (item) {
...
function renderNewProduct(item) {
  var template = "<div class=\"food-item\">\n    <div class=\"food-image\">\n      <img src=\"".concat(item.image, "\" alt=\"\" />\n    </div>\n    <div class=\"food-body\">\n      <div class=\"food-name\">").concat(item.name, "</div>\n      <div class=\"food-price\">$ ").concat(item.price, "</div>\n    </div>\n  </div>");
  foodList.insertAdjacentHTML("beforeend", template);
}

// Hiển thị chi tiết sản phẩm
productDetailApi.getProductById(productId).then(function (item) {
...
},{}]},{},["node_modules/parcel-bundler/src/builtins/hmr-runtime.js","app/productDetail.js"], null)
//# sourceMappingURL=/productDetail.3779e953.js.map