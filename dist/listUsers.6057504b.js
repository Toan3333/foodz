...
exports.Axios = Axios;
},{"./lib/axios.js":"node_modules/axios/lib/axios.js"}],"app/services/userService.js":[function(require,module,exports) {
"use strict";
...
var userService = /*#__PURE__*/_createClass(function userService(endPoint) {
  var _this = this;
  _classCallCheck(this, userService);
  _defineProperty(this, "getUsers", /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    var response;
  ...
  _defineProperty(this, "getUserId", /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
    var response, user;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 7:
          return _context2.abrupt("return", (parseInt(user[user.length - 1].id, 10) + 1).toString());
        case 10:
          _context2.prev = 10;
  ...
  _defineProperty(this, "addUser", /*#__PURE__*/function () {
    var _ref4 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4(newUser) {
      var response;
      return _regeneratorRuntime().wrap(function _callee4$(_context4) {
        while (1) switch (_context4.prev = _context4.next) {
          case 0:
            _context4.prev = 0;
            _context4.next = 3;
            return _axios.default.post(_this.endPoint + _this.collectionName, newUser);
          case 3:
  ...
  _defineProperty(this, "updateUser", /*#__PURE__*/function () {
    var _ref6 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee6(id, newUserUpdate) {
      var response;
      return _regeneratorRuntime().wrap(function _callee6$(_context6) {
        while (1) switch (_context6.prev = _context6.next) {
          case 0:
            _context6.prev = 0;
            _context6.next = 3;
            return _axios.default.put("".concat(_this.endPoint).concat(_this.collectionName, "/").concat(id), newUserUpdate);
          case 3:
...
},{}],"app/listUsers.js":[function(require,module,exports) {
var define;
"use strict";
...
function asyncGeneratorStep(n, t, e, r, o, a, c) { try { var i = n[a](c), u = i.value; } catch (n) { return void e(n); } i.done ? t(u) : Promise.resolve(u).then(r, o); }
function _asyncToGenerator(n) { return function () { var t = this, e = arguments; return new Promise(function (r, o) { var a = n.apply(t, e); function _next(n) { asyncGeneratorStep(a, r, o, _next, _throw, "next", n); } function _throw(n) { asyncGeneratorStep(a, r, o, _next, _throw, "throw", n); } _next(void 0); }); }; }
var userApi = new _userService.default(_JsonServerConstants.default.EndPoint);
var showUser = document.querySelector("#showUser");
var formUserPost = document.querySelector(".form-user-post");
var formUserEdit = document.querySelector("#formUserEdit");
// Thêm biến global để lưu trữ thông tin sản phẩm hiện tại
var currentUser = null;
showUser.addEventListener("click", /*#__PURE__*/function () {
...
formUserEdit.addEventListener("submit", /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(e) {
    var usernameUpdate, passwordUpdate, roleUpdate, id, updatedUser;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          e.preventDefault();
          usernameUpdate = document.querySelector("#usernameUpdate").value;
          passwordUpdate = document.querySelector("#passwordUpdate").value;
          roleUpdate = document.querySelector("#roleUpdate").value;
...
formUserPost.addEventListener("submit", /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(e) {
    var username, password, role, userId, addUsers;
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        case 0:
          e.preventDefault();
...
},{"./services/userService":"app/services/userService.js","./constants/JsonServerConstants":"app/constants/JsonServerConstants.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
},{}]},{},["node_modules/parcel-bundler/src/builtins/hmr-runtime.js","app/listUsers.js"], null)
//# sourceMappingURL=/listUsers.6057504b.js.map