...
},{}],"app/listProduct.js":[function(require,module,exports) {
"use strict";
...
var specialList = document.querySelector(".special-list");
var hotList = document.querySelector("#hot");
function renderProducts(product) {
  var template = "<div class=\"special-item\">\n  <div class=\"special-image\">\n    <a href=\"/public/pages/product-detail.html?id=".concat(product.id, "\">\n      <img src=\"").concat(product.image, "\" alt=\"\" />\n    </a>\n    <i class=\"fa fa-heart\" aria-hidden=\"true\"></i>\n    <i class=\"fa fa-eye\" aria-hidden=\"true\"></i>\n  </div>\n  <div class=\"special-title\">").concat(product.name, "</div>\n  <div class=\"special-rating\">\n    <div class=\"special-icon\">\n      <i class=\"fa fa-star\" aria-hidden=\"true\"></i>\n      <i class=\"fa fa-star\" aria-hidden=\"true\"></i>\n      <i class=\"fa fa-star\" aria-hidden=\"true\"></i>\n      <i class=\"fa fa-star\" aria-hidden=\"true\"></i>\n      <i class=\"fa fa-star\" aria-hidden=\"true\"></i>\n    </div>\n    <div class=\"special-views\">214 Reviews</div>\n  </div>\n  <div class=\"special-bottom\">\n    <div class=\"special-price\">$ ").concat(product.price, "</div>\n    <div class=\"special-button\">\n      <button class=\"button-primary\" id=\"orderBtn\" data-id=\"").concat(product.id, "\" >ORDER NOW</button>\n    </div>\n  </div>\n</div>");
  specialList.insertAdjacentHTML("beforeend", template);
}
// thêm vào giỏ hàng
specialList.addEventListener("click", /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(e) {
    var id, product, cart, index;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
        ...
        case 5:
          ...
          index = cart.findIndex(function (item) {
...
hotList.addEventListener("click", /*#__PURE__*/function () {
...
productsApi.findAllProducts().then(function (data) {
  console.log(data);
  var specialProduct = data.filter(function (item) {
    return item.category === "special";
  });
  var hotProduct = data.filter(function (item) {
    return item.category === "hot";
  });
  specialProduct.forEach(function (product) {
    renderProducts(product);
  });
  hotProduct.forEach(function (product) {
...
},{}]},{},["node_modules/parcel-bundler/src/builtins/hmr-runtime.js","app/listProduct.js"], null)
//# sourceMappingURL=/listProduct.e5dcc09a.js.map