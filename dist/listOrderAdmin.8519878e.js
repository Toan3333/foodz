...
},{}],"app/listOrderAdmin.js":[function(require,module,exports) {
"use strict";
...
function asyncGeneratorStep(n, t, e, r, o, a, c) { try { var i = n[a](c), u = i.value; } catch (n) { return void e(n); } i.done ? t(u) : Promise.resolve(u).then(r, o); }
function _asyncToGenerator(n) { return function () { var t = this, e = arguments; return new Promise(function (r, o) { var a = n.apply(t, e); function _next(n) { asyncGeneratorStep(a, r, o, _next, _throw, "next", n); } function _throw(n) { asyncGeneratorStep(a, r, o, _next, _throw, "throw", n); } _next(void 0); }); }; }
var orderAdminApi = new _orderService.default(_JsonServerConstants.default.EndPoint);
var showOrder = document.querySelector("#showOrder");
function renderOrderAdmin(item) {
  var template = "<tr>\n  <td>".concat(item.id, "</td>\n  <td>").concat(item.name, "</td>\n  <td class=\"order-address\">").concat(item.address, "</td>\n  <td>").concat(item.orderDate, "</td>\n  <td>$ ").concat(item.totalAmount, "</td>\n  <td style=\"color: red\">").concat(item.status, "</td>\n  <td>\n    <div class=\"edit-auth\">\n      <a href=\"#\" class=\"delete-btn\" data-id=\"").concat(item.id, "\">Delete</a>\n    </div>\n  </td>\n</tr>");
  showOrder.insertAdjacentHTML("beforeend", template);
}
showOrder.addEventListener("click", /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          _context.prev = 3;
          _context.next = 6;
          return orderAdminApi.deleteOrder(id);
        case 6:
...
orderAdminApi.getOrder().then(function (data) {
  console.log(data);
...
},{}]},{},["node_modules/parcel-bundler/src/builtins/hmr-runtime.js","app/listOrderAdmin.js"], null)
//# sourceMappingURL=/listOrderAdmin.8519878e.js.map