...
})({"fCEJh":[function(require,module,exports) {
...
module.bundle.HMR_BUNDLE_ID = "fb81d8bdca69b947";
"use strict";
...
},{}],"bLoNB":[function(require,module,exports) {
...
const orderApi = new (0, _orderServiceDefault.default)((0, _jsonServerConstantsDefault.default).EndPoint);
...
formOrder.addEventListener("submit", async (e)=>{
    ...
    try {
        ...
        alert("\u0110\u01A1n h\xe0ng \u0111\xe3 \u0111\u01B0\u1EE3c t\u1EA1o th\xe0nh c\xf4ng!");
    } catch (error) {
        console.log(error);
        // Xử lý lỗi nếu có
        alert("\u0110\xe3 c\xf3 l\u1ED7i x\u1EA3y ra khi t\u1EA1o \u0111\u01A1n h\xe0ng. Vui l\xf2ng th\u1EED l\u1EA1i sau.");
    }
});

},{"./services/orderService":"ee1dF","./constants/JsonServerConstants":"6L6hL","@parcel/transformer-js/src/esmodule-helpers.js":"2GZEo"}],"ee1dF":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
class orderService {
    ...
    addOrder = async (createOrder)=>{
        const response = await (0, _axiosDefault.default).post(this.endPoint + this.collectionName, createOrder);
        return response.data;
    };
...
},{"axios":"jo6P5","@parcel/transformer-js/src/esmodule-helpers.js":"2GZEo"}]},["fCEJh","bLoNB"], "bLoNB", "parcelRequire06c3")

//# sourceMappingURL=checkout.ca69b947.js.map
