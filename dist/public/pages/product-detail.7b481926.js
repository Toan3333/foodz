...
})({"hiL9u":[function(require,module,exports) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "27716c4a7b481926";
"use strict";
...
},{}],"dm2m7":[function(require,module,exports) {
...
const productDetailApi = new (0, _productServiceDefault.default)((0, _jsonServerConstantsDefault.default).EndPoint);
...
},{"./services/productService":"742q3","./constants/JsonServerConstants":"6L6hL","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"742q3":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
class productService {
    ...
    addAllProducts = async (newProduct)=>{
        const response = await (0, _axiosDefault.default).post(this.endPoint + this.collectionName, newProduct);
        return response.data;
    };
    ...
    deleteProduct = async (productId)=>{
        const response = await (0, _axiosDefault.default).delete(`${this.endPoint}${this.collectionName}/${productId}`);
        return response.data;
    };
    updateProduct = async (productId, updatedProduct)=>{
        const response = await (0, _axiosDefault.default).put(`${this.endPoint}${this.collectionName}/${productId}`, updatedProduct);
        return response.data;
    };
}
exports.default = productService;

},{"axios":"jo6P5","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["hiL9u","dm2m7"], "dm2m7", "parcelRequire06c3")

//# sourceMappingURL=product-detail.7b481926.js.map
